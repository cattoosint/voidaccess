...
def cached_scrape_multiple(filtered: list, threads: int):
    return asyncio.run(scrape_multiple(filtered, max_workers=threads))


# Streamlit page configuration
st.set_page_config(
    page_title="VoidAccess: Dark Web Intelligence Platform",
    page_icon="🕵️‍♂️",
...
if not model_options:
    st.sidebar.error(
        ...
        "Set at least one in your `.env` file and restart VoidAccess.\n\n"
...
with logo_col:
    st.image(".github/assets/voidaccess_logo.png", width=200)
...
try:
    import ui_integration  # noqa: F401  — Phase 6 optional extension
except ImportError:
    pass
